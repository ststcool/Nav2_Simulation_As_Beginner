...
| 4 | 算法对比与自动化测试 | ★★★☆☆ | 4 种 Planner×Controller 对比、send_goal + run_tests 框架 | `nav2_algorithm_lab` + `nav2_testbed` |https://zhuanlan.zhihu.com/p/2052449634447110732|
| 5 | 视觉 SLAM 入门——RTAB-Map + Nav2 仿真导航 | ★★★★☆ | 深度相机改造、RTAB-Map 配置、三种模式对比 | `nav2_visual_slam` |https://zhuanlan.zhihu.com/p/2063719610344551217|
